...
public abstract class AbstractRaffleStrategy implements IRaffleStrategy {
    ...
    public AbstractRaffleStrategy(IStrategyRepository repository, IStrategyDispatch strategyDispatch, DefaultChainFactory chainFactory, DefaultTreeFactory defaultTreeFactory) {
